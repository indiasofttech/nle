...
$database_name = 'jobsglob_nle';

# what user has access to this database
$database_user = 'jobsglob_nle';

# and what is the password to login to control the database
$database_password = 'campaign';
...
$phplist_user_attribute=mysql_query("select * from phplist_smtp_list where status='1'");
$smtp_list_d=mysql_fetch_array($phplist_user_attribute);
		 define ("TEST",0);
		
		define("PHPMAILER",1);
		define("SMTPSecure",$smtp_list_d['smtpsecure']);

		define("PHPMAILERHOST",$smtp_list_d['mailhost']);
		define("PHPMAILERPORT",$smtp_list_d['smtpport']);
		$phpmailer_smtpuser = $smtp_list_d['smtpuser'];
		$phpmailer_smtppassword =$smtp_list_d['smtppassword'];



# if you have an SMTP server, set it here. Otherwise it will use the normal php mail() function
## if your SMTP server is called "smtp.indiasofttech.com" you enter this below like this:
##
##     define("PHPMAILERHOST",'smtp.indiasofttech.com');
...
# but a mailbox that phpList can empty every so often, to process the bounces
 $message_envelope = 'emma.ilextech@gmail.com';
