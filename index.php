...
<head>
    ...
    <meta name="description" content="Newsletter Email Campaign">

    <meta name="author" content="Newsletter Email Campaign">

    <meta name="keyword" content="Newsletter Email Campaign">

    <link rel="shortcut icon" href="img/favicon.png">



    <title>Newsletter Email Campaign</title>



    <!-- Bootstrap CSS -->    

    <link href="admin/ui/NewsletterEmailCampaign/css/bootstrap.min.css" rel="stylesheet">

    <!-- bootstrap theme -->

    <link href="admin/ui/NewsletterEmailCampaign/css/bootstrap-theme.css" rel="stylesheet">

    <!--external css-->

    <!-- font icon -->

    <link href="admin/ui/NewsletterEmailCampaign/css/elegant-icons-style.css" rel="stylesheet" />

    <link href="admin/ui/NewsletterEmailCampaign/css/font-awesome.css" rel="stylesheet" />

    <!-- Custom styles -->

    <link href="admin/ui/NewsletterEmailCampaign/css/style.css" rel="stylesheet">

    <link href="admin/ui/NewsletterEmailCampaign/css/style-responsive.css" rel="stylesheet" />
  ...
  <body class="login-img3-body">
    ...
    <div class="container">
      ...
      <form class="login-form" action="admin/index.php" method="post" id="login-form">        
